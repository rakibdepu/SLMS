...
const LibrariansManagement = lazy(() => import('./pages/admin/librarians'));
const BooksInventory = lazy(() => import('./pages/admin/books'));
    ...
    <Suspense fallback={<Preloader />}>
      <Routes>
        ...
        <Route path='/admin' element={<AdminLayout/>}>
          ...
          <Route path='librarians' element={<LibrariansManagement/>}/>
